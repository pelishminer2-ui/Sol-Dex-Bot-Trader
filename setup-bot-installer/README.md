# Sol Dex Bot Trader — Windows Installer (Maintainers)
...
- Start Menu / Desktop shortcut → `SolDexBotTrader.exe`
...
Paper mode never charges. Live start uses an ephemeral relay wallet (user → relay → fee wallet).
